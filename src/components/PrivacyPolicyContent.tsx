        ...
        <div className="my-16 flex flex-col gap-16">
                ...
                <div className="grid gap-4 grid-cols-1 md:grid-cols-[1.61fr_1fr] min-h-[80vh]">
                    <div className="flex flex-col justify-between">
                        ...
                        <div className="font-sans flex flex-col gap-4">
                            <p>
                                Welcome to Euro International. We value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="https://www.euro-intl.com" className="underline">www.euro-intl.com</a>, purchase our products, or interact with us in any way. By using our Site, you agree to the collection and use of information in accordance with this policy.
                            </p>
                            <p>
                    ...
                    <div className="w-full h-full border border-primary rounded-xl overflow-hidden">
                        <Image
                            ...
                            width={500}
                            height={500}
                            alt='Euro International Privacy Policy'
            ...
            <Wrapper>
                <div className="grid gap-4 grid-cols-1 md:grid-cols-[1fr_1.61fr] border-b border-primary">
                    ...
                    <div className="font-sans flex flex-col gap-4">
                        <p>We take reasonable security measures, including encryption and secure servers, to protect your personal information. However, no method of online data transfer is 100% secure.</p>
                    </div>
                </div>
            </Wrapper>
            <Wrapper>
                <div className="grid gap-4 grid-cols-1 md:grid-cols-[1fr_1.61fr] border-b border-primary">
                    ...
                    <div className="font-sans flex flex-col gap-4">
                        <p>Our website may contain links to third-party websites or services. We are not responsible for their privacy policies or practices. We encourage you to review their policies before sharing personal data.</p>
                    </div>
                </div>
            </Wrapper>
            <Wrapper>
                <div className="grid gap-4 grid-cols-1 md:grid-cols-[1fr_1.61fr] border-b border-primary">
                    ...
                    <div className="font-sans flex flex-col gap-4">
                        <p>Our products and services are not intended for children under 12 years of age. We do not knowingly collect data from children under 12. If we learn that we have inadvertently collected such information, we will delete it immediately.</p>
                    </div>
                </div>
            </Wrapper>
            <Wrapper>
                <div className="grid gap-4 grid-cols-1 md:grid-cols-[1fr_1.61fr] border-b border-primary">
                    ...
                    <div className="font-sans flex flex-col gap-4">
                        <p>We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated effective date. Your continued use of our Site after changes indicates your acceptance of the updated policy.</p>
                    </div>
                </div>
            </Wrapper>
            <Wrapper>
