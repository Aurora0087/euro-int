...
function Hero() {
    ...
    return (
        <div className='relative w-full h-svh overflow-hidden bg-zinc-950'>
            ...
            >
                ...
                <a href="/" className='group relative flex items-center justify-center overflow-hidden'>
                    <div className='relative w-32 h-10'>
                        <Image fill alt='Euro International logo' src="/logo.png" className='object-contain transition-transform duration-500 group-hover:scale-105' />
                    </div>
                </a>

                {/* Header Actions */}
                <div className='flex gap-3 md:gap-4 justify-end items-center w-fit'>
                            ...
                            <SheetHeader className="h-full flex flex-col justify-center">
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full text-zinc-300'>
                                    <div className='group flex flex-col gap-3 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/50 hover:border-zinc-700 transition-colors rounded-2xl p-6'>
                                        ...
                                        <h4 className='font-semibold text-white tracking-wide uppercase text-xs'>{t('hero_tannery_label')}</h4>
                                    ...
                                    <div className='group flex flex-col gap-3 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/50 hover:border-zinc-700 transition-colors rounded-2xl p-6'>
                                        <MapPin className='w-6 h-6 text-white/50 group-hover:text-white transition-colors' />
                                        <h4 className='font-semibold text-white tracking-wide uppercase text-xs'>{t('hero_factory_label')}</h4>
                                        <div className='text-sm leading-relaxed'>
                                    ...
                                    <div className='group flex flex-col gap-3 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/50 hover:border-zinc-700 transition-colors rounded-2xl p-6'>
                                        ...
                                        <h4 className='font-semibold text-white tracking-wide uppercase text-xs'>{t('hero_email_label')}</h4>
                                    ...
                                    <div className='group flex flex-col gap-3 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/50 hover:border-zinc-700 transition-colors rounded-2xl p-6'>
                                        ...
                                        <h4 className='font-semibold text-white tracking-wide uppercase text-xs'>{t('hero_phone_label')}</h4>
                                        <div className='flex flex-col gap-1 text-sm'>
            ...
            <div className='absolute z-20 inset-0 flex flex-col justify-end pb-24 md:pb-32 px-6 md:px-12'>
                ...
                >
                    ...
                    <div className="overflow-hidden py-2">
                        ...
                        >
                            {t('hero_headline_1')} <br className="hidden md:block" /> {t('hero_headline_2')}
                        </motion.h1>
                    </div>
            ...
            >
                <span className="text-xs uppercase tracking-widest origin-center rotate-90 mb-8">{t('hero_scroll')}</span>
